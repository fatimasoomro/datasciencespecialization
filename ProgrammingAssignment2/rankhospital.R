rankhospital <- function(state, outcome, num="best"){
  ...
  if(is.numeric(num)){
    if( length(validVec) < num) {
      return ("NA")
    }
  }

  ## Outcome, state and num are OK. Now find the ranking of the hospitals
  ## Return a data frame with hospital name, rate and ranking
  ...
  #print(is.character(result))
  #print(is.vector(result))
  #print(result)
  return(result)
